...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/0maru/weaver-sample/Reverser",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return reverser_client_stub{stub: stub, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/0maru/weaver-sample/Reverser", Method: "Reverse"})}
		},
